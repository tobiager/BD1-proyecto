...
7. [Modulo 1 - Manejo de Permisos a Nivel de Usuarios de Base de Datos](modulo1-permisos.md)
   1. [Contenidos de esta carpeta](modulo1-permisos.md#contenidos-de-esta-carpeta)
   2. [Cómo ejecutar (paso a paso)](modulo1-permisos.md#cómo-ejecutar-paso-a-paso)
   3. [Qué se demuestra](modulo1-permisos.md#qué-se-demuestra)
   4. [Criterios de Evaluación (cómo lo cumplimos)](modulo1-permisos.md#criterios-de-evaluación-cómo-lo-cumplimos)
   5. [Entregables](modulo1-permisos.md#entregables)
   6. [Notas](modulo1-permisos.md#notas)
